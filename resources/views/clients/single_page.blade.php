            ...
            <div class="single_page_content"> <img class="img-center" src="../images/single_post_img.jpg" alt="">
              ...
              <div class="comment-wrapper">
                <div class="panel panel-info" style="border-color: #70ad47;">
                    <div class="panel-heading" style="color:white;background-color:#70ad47;border-color:#70ad47">
                        Comment panel
                    </div>
                    <div class="panel-body">
                        <textarea class="form-control" placeholder="write a comment..." rows="3"></textarea>
                        <br>
                        <button type="button" class="btn btn-info pull-right" style="color:white;background-color:#70ad47;border-color:#70ad47;">Post</button>
