...
<head>
  ...
  <title>Quản lý chuyên mục tin tức</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh sách chuyên mục tin tức</h1>
          </div>
          {{-- <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách chuyên mục tin tức</h3>
                  ...
                  <tbody>
                    @if (!empty($categories))
                        ...
                        <tr>
                          ...
                          @endif
                          <td>
                            <a href="{{route('admin.categories-edit',['id' => $item->CateID])}}" class="btn btn-primary">Sửa</a>
                            <a href="{{route('admin.categories-delete',['id' => $item->CateID])}}" onclick="return confirm('Bạn có chắc chắn muốn xóa chuyên mục này?');" class="btn btn-warning">Xóa</a>
                          </td>
                        </tr>
                        @endforeach
                    @endif
