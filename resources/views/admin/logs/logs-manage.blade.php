                ...
                <table class="table table-bordered  table-hover table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                      ...
                      <th style="vertical-align: top;">Tên người dùng</th>
                      <th style="vertical-align: top;">Chức vụ</th>
                      <th style="vertical-align: top; max-width: 500px;">Hành động</th>
                      <th style="vertical-align: top;">Thời điểm diễn ra</th>
                  ...
                  <tbody>
                    @if (!empty($logs))
                        ...
                        <tr>
                          ...
                          <td>{{$item->Role}}</td>
                          <td style="max-width: 500px;word-break: break-word;white-space: normal;">{{$item->Activity}}</p></td>
