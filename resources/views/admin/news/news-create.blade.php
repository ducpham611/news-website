              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Tiêu đề bài viết" name="title" value="{{old('title')}}">
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="excerpt" id="" cols="30" rows="5"  class="form-control" placeholder="Trích đoạn">{{old('excerpt')}}</textarea>
                    @error('excerpt')
                        <span style="color:red;">{{$message}}</span>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="mytextarea" name="content" placeholder="Nội dung bài viết">{{old('content')}}</textarea>
                    @error('content')
                        <span style="color:red;">{{$message}}</span>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Chú thích hình ảnh" name="imageDescription" value="{{old('imageDescription')}}">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" style="margin-left: -15px;">Tạo bài viết</button>
